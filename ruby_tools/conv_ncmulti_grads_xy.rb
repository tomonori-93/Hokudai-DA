...
ens_num = 1
memf = ARGV[1]
#memf = "hist.d01_20180926-000000.000.pe00"
outfile = ARGV[2]
#outfile = "hist.geo_20180926-000000.bin"
aval = [ "topo", "lat", "lon" ]  # ens_mean variable
axname = [ "x", "y" ]
...
#p tax.pos.get_att("units")
      ...
      u_var[0..xax.length-1,0..yax.length-1,0,0] = u_memv.val[0..xax.length-1,0..yax.length-1]
      ...
      #GPhys::GrADS_IO.write("#{ens_dir}/#{outfile}",u_out,name=aval)
