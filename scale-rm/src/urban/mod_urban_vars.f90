...
module mod_urban_vars
  ...
  public :: URBAN_vars_restart_create_add  ! add by satoki
...
contains
  ...
  subroutine URBAN_vars_restart_create_add( addfname )
    use scale_time, only: &
       TIME_gettimelabel
    use scale_fileio, only: &
       FILEIO_create
    ...
    return
  end subroutine URBAN_vars_restart_create_add
