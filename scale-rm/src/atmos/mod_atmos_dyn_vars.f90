...
module mod_atmos_dyn_vars
  ...
  public :: ATMOS_DYN_vars_restart_create_add  ! add by satoki
...
contains
  ...
  subroutine ATMOS_DYN_vars_restart_create_add( addfname )
    use scale_time, only: &
       TIME_gettimelabel
    use scale_fileio, only: &
       FILEIO_create
    ...
    return
  end subroutine ATMOS_DYN_vars_restart_create_add
