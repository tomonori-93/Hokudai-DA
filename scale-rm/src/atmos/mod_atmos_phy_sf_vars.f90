...
module mod_atmos_phy_sf_vars
  ...
  public :: ATMOS_PHY_SF_vars_restart_create_add  ! add by satoki
...
!   ATMOS_PHY_SF_SFC_albedo(:,:,:) = UNDEF ! [del] 2014/8/28 A.Noda
  ...
  subroutine ATMOS_PHY_SF_vars_restart_create_add( addfname )
    use scale_time, only: &
       TIME_gettimelabel
    use scale_fileio, only: &
       FILEIO_create
    ...
    return
  end subroutine ATMOS_PHY_SF_vars_restart_create_add
