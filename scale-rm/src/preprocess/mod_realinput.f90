...
!(satoki) write(*,*) "Enter interp_ocean in ParentSurfaceInput"
          call interp_OceanLand_data(tw_org, omask, odims(1), odims(2), .false., intrp_iter_max)
!(satoki) write(*,*) "Exit interp_ocean in ParentSurfaceInput"
       end if
...
write(*,*) "Exit interp_ocean in ParentSurfaceInput"
       end if
...
!(satoki) write(*,*) "Enter interp_ocean in land_interporation"
       call interp_OceanLand_data(lst_org, lmask, ldims(2), ldims(3), .true., intrp_iter_max)
!(satoki) write(*,*) "Exit interp_ocean in land_interporation"
    end if
