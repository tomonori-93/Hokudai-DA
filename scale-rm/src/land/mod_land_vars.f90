...
module mod_land_vars
  ...
  public :: LAND_vars_restart_create_add  ! add by satoki
...
contains
  ...
  subroutine LAND_vars_restart_create_add( addfname )
    use scale_time, only: &
       TIME_gettimelabel
    use scale_fileio, only: &
       FILEIO_create
    ...
    return
  end subroutine LAND_vars_restart_create_add
